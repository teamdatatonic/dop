...
from dop.component.transformation.common.parser.yaml_parser import yaml_to_dict, dict_to_yaml
...
def setup_profiles(project_name):
    ...
    path_to_dbt_project_yml = os.path.sep.join([env_config.dbt_projects_path, project_name, 'dbt_project.yml'])
