...
class RunnerEnvironment:
    def __init__(self, runner):
        if runner not in definitions.SUPPORTED_TRANSFORMATION_RUNNERS:
            raise NotImplementedError(f'Transformation Runner "{runner}" is not supported')
    ...
    def _get_runner_template_paths(self):
        ...
        runner_base_path = os.path.join(
            definitions.ROOT_DIR, 'component', 'transformation', 'runner', self._runner, 'template', 'macro'
        )
